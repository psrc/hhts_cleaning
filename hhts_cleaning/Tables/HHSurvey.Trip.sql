...
[pernum] [int] NULL,
[tripid] [decimal] (19, 0) NULL,
[tripnum] [int] NOT NULL CONSTRAINT [DF__Trip__tripnum__511C966A] DEFAULT ((0)),
[traveldate] [datetime2] NULL,
[daynum] [int] NULL,
[copied_trip] [int] NULL,
[svy_complete] [int] NULL,
...
[psrc_resolved] [smallint] NULL,
[psrc_comment] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[valid_from] [datetime2] GENERATED ALWAYS AS ROW START HIDDEN NOT NULL CONSTRAINT [HHSurvey_Trip_valid_from_default] DEFAULT (sysutcdatetime()),
[valid_to] [datetime2] GENERATED ALWAYS AS ROW END HIDDEN NOT NULL CONSTRAINT [HHSurvey_Trip_valid_to_default] DEFAULT ('9999-12-31 23:59:59.9999999'),
