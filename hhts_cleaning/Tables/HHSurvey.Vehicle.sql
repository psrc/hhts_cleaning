...
[toll_transponder] [int] NOT NULL,
[survey_year] [smallint] NOT NULL,
[valid_from] [datetime2] GENERATED ALWAYS AS ROW START HIDDEN NOT NULL CONSTRAINT [HHSurvey_Vehicle_valid_from_default] DEFAULT (sysutcdatetime()),
[valid_to] [datetime2] GENERATED ALWAYS AS ROW END HIDDEN NOT NULL CONSTRAINT [HHSurvey_Vehicle_valid_to_default] DEFAULT ('9999-12-31 23:59:59.9999999'),
