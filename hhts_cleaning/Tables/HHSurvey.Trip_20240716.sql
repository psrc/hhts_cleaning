CREATE TABLE [HHSurvey].[Trip_20240716]
(
...
[tripnum] [int] NOT NULL CONSTRAINT [DF__Trip_2024__tripn__2241ABF0] DEFAULT ((0)),
...
GO
ALTER TABLE [HHSurvey].[Trip_20240716] ADD CONSTRAINT [PK__Trip_202__1B427A0AE591722F] PRIMARY KEY CLUSTERED ([recid]) ON [PRIMARY]
GO
