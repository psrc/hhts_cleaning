...
[OsmClass] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[OsmType] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[dest_purpose] [int] NULL
) ON [PRIMARY]
GO
ALTER TABLE [HHSurvey].[OsmType_purpose_lookup] ADD CONSTRAINT [PK__OsmType___3F19910D835FA063] PRIMARY KEY CLUSTERED ([OsmType_id]) ON [PRIMARY]
GO
