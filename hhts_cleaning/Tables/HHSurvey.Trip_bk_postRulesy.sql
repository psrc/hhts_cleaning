CREATE TABLE [HHSurvey].[Trip_bk_postRulesy]
(
[recid] [int] NOT NULL,
...
GO
ALTER TABLE [HHSurvey].[Trip_bk_postRulesy] ADD CONSTRAINT [PK__Trip_bk___1B427A0A6E2E13A4] PRIMARY KEY CLUSTERED ([recid]) ON [PRIMARY]
GO
