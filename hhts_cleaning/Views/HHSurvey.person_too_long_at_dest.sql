...
SET ANSI_NULLS ON
GO
        CREATE VIEW [HHSurvey].[person_too_long_at_dest] WITH SCHEMABINDING AS
        ...
        WHERE p.person_id IN (SELECT person_id FROM HHSurvey.trip_error_flags WHERE error_flag='too long at dest?')
GO
