...
SET ANSI_NULLS ON
GO
        -- DROP VIEW IF EXISTS HHSurvey.person_too_long_at_dest
        -- Go
        CREATE VIEW [HHSurvey].[person_mode_1_missing] WITH SCHEMABINDING AS
        ...
        WHERE p.person_id IN (SELECT person_id FROM HHSurvey.trip_error_flags WHERE error_flag='mode_1 missing')
GO
